...
public class ConnectionScreen extends Screen {
    ...
    protected void init() {
        ...
        this.refreshQrButton = new Button(refresh.x(), refresh.y(), refresh.width(), refresh.height(),
            Component.translatable("button.dglabcraft.refresh_qr"), button -> {
        ...
        this.openQrButton = new Button(open.x(), open.y(), open.width(), open.height(),
            Component.translatable("button.dglabcraft.open_qr_image"), button -> {
        ...
        this.openQrFolderButton = new Button(openFolder.x(), openFolder.y(), openFolder.width(), openFolder.height(),
            Component.translatable("button.dglabcraft.open_qr_folder"), button -> {
            File qrFile = getQrCodeFile();
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        drawCenteredString(poseStack, this.font, Component.translatable("screen.dglabcraft.connection_settings"),
        ...
        drawCenteredString(poseStack, this.font, Component.translatable("label.dglabcraft.address",
        ...
        if (isConnected) {
            ...
            if (clientId != null) {
                drawCenteredString(poseStack, this.font, Component.translatable("label.dglabcraft.device", clientId), centerX, 90, 0xAAAAAA);
            }
        }
    }
    ...
    private void renderQrPanel(PoseStack poseStack, ConnectionLayout.Layout layout, File qrFile) {
        ...
        if (qrFile.isFile() && loadQrTexture(qrFile)) {
            ...
            drawCenteredString(poseStack, this.font, Component.translatable("message.dglabcraft.scan_qr"),
