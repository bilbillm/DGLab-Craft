...
public class DiagnosticScreen extends Screen {
    ...
    protected void init() {
        ...
        this.regenerateQrButton = new Button(startX, firstRowY, BUTTON_WIDTH, BUTTON_HEIGHT,
            Component.translatable("button.dglabcraft.regenerate_qr"),
        ...
        this.silenceButton = new Button(startX, secondRowY, BUTTON_WIDTH, BUTTON_HEIGHT,
            Component.translatable("button.dglabcraft.stop_feedback_now"),
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        drawCenteredString(poseStack, this.font, Component.translatable("screen.dglabcraft.diagnostics"), centerX, y, 0xFFFFFF);
        y += 18;
        drawCenteredString(poseStack, this.font, Component.translatable("message.dglabcraft.diagnostics_summary"), centerX, y, 0xAAAAAA);
        y += 20;
        ...
        y = drawSection(poseStack, contentX, y, Component.translatable("section.dglabcraft.connection_status"), buildConnectionLines(server));
        y = drawSection(poseStack, contentX, y, Component.translatable("section.dglabcraft.channel_status", "A"), buildChannelLines(server, "A"));
        y = drawSection(poseStack, contentX, y, Component.translatable("section.dglabcraft.channel_status", "B"), buildChannelLines(server, "B"));
        y = drawSection(poseStack, contentX, y, Component.translatable("section.dglabcraft.runtime_summary"), buildRuntimeLines(server));
        drawSection(poseStack, contentX, y, Component.translatable("section.dglabcraft.details"), buildDetailLines(server));
