...
Current branch: `1.20.1`
Target version: Minecraft `1.20.1` / Forge `47.2.0` / Java `17`
...
1. Open this release: [`DGLabCraft-1.20.1-1.0.11.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.0.11-1.20.1)
2. Scroll to **Assets**.
3. Download `DGLabCraft-1.20.1-1.0.11.jar`.
...
4. Put `DGLabCraft-1.20.1-1.0.11.jar` into that folder.
...
```bash
git clone -b 1.20.1 https://github.com/bilbillm/DGLab-Craft.git
cd DGLab-Craft
./gradlew build
```
...
```bash
pwsh scripts/release-check.ps1 -Tag v1.0.11-1.20.1 -SkipGitHubReleaseCheck
pwsh scripts/release-postcheck.ps1 -Tag v1.0.11-1.20.1
```
