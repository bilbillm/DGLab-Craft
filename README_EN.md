...
1. Open this release: [`DGLabCraft-1.19.2-1.0.6.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.0.6-1.19.2)
2. Scroll to **Assets**.
3. Download `DGLabCraft-1.19.2-1.0.6.jar`.
...
4. Put `DGLabCraft-1.19.2-1.0.6.jar` into that folder.
