...
Target version: Minecraft `1.16.5` / Forge `36.2.42` / Java `8`
...
1. Open the unified release: [`DGLabCraft-1.18.2-1.1.1.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.1.1)
2. Scroll to **Assets**.
3. Download `DGLabCraft-1.18.2-1.1.1.jar`.
...
2. Install Forge `36.2.42` for that instance.
3. Open the instance's `mods` folder. A common path is `.minecraft/mods`.
4. Put `DGLabCraft-1.18.2-1.1.1.jar` into that folder.
...
```bash
git clone -b 1.18.2 https://github.com/bilbillm/DGLab-Craft.git
cd DGLab-Craft
./gradlew build
```
