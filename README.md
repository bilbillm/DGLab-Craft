...
当前分支：`1.20.1`
适配版本：Minecraft `1.20.1` / Forge `47.2.0` / Java `17`
...
1. 打开这个版本的 release：[`DGLabCraft-1.20.1-1.0.11.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.0.11-1.20.1)
2. 在页面下方找到 **Assets**。
3. 下载 `DGLabCraft-1.20.1-1.0.11.jar`。
...
4. 把刚下载的 `DGLabCraft-1.20.1-1.0.11.jar` 放进去。
