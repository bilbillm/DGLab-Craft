...
当前分支：`1.18.2`
适配版本：Minecraft `1.16.5` / Forge `36.2.42` / Java `8`
...
1. 打开统一 release：[`DGLabCraft-1.18.2-1.1.1.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.1.1)
2. 在页面下方找到 **Assets**。
3. 下载 `DGLabCraft-1.18.2-1.1.1.jar`。
...
2. 给这个实例安装 Forge `36.2.42`。
3. 打开实例目录里的 `mods` 文件夹。常见路径是 `.minecraft/mods`。
4. 把刚下载的 `DGLabCraft-1.18.2-1.1.1.jar` 放进去。
