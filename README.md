...
> 提醒：这个版本的 release 标注为未经实机测试；如果你只是想稳定游玩，优先选择与你 MC 版本完全一致且已测试过的版本。
...
| 1.21.4 | NeoForge 21.4.x | `1.21.4-NeoForge` | [v1.0.7](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.0.8-1.21.4-NeoForge) |

### 2. 在 GitHub 下载 Mod

1. 打开这个版本的 release：[`DGLabCraft-1.21.4-1.0.8.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.0.8-1.21.4-NeoForge)
2. 在页面下方找到 **Assets**。
3. 下载 `DGLabCraft-1.21.4-1.0.8.jar`。
...
4. 把刚下载的 `DGLabCraft-1.21.4-1.0.8.jar` 放进去。
