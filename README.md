...
1. 打开这个版本的 release：[`DGLabCraft-1.21.4-1.1.0.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.1.0-1.21.4-NeoForge)
2. 在页面下方找到 **Assets**。
3. 下载 `DGLabCraft-1.21.4-1.1.0.jar`。
...
4. 把刚下载的 `DGLabCraft-1.21.4-1.1.0.jar` 放进去。
...
```bash
pwsh scripts/release-check.ps1 -Tag v1.1.0-1.21.4-NeoForge -SkipGitHubReleaseCheck
pwsh scripts/release-postcheck.ps1 -Tag v1.1.0-1.21.4-NeoForge
```
