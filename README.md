...
1. 打开统一 release：[`DGLabCraft-1.21.1-1.1.1.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.1.1)
2. 在页面下方找到 **Assets**。
3. 下载 `DGLabCraft-1.21.1-1.1.1.jar`。
...
4. 把刚下载的 `DGLabCraft-1.21.1-1.1.1.jar` 放进去。
