...
1. 打开这个版本的 release：[`DGLabCraft-1.18.2-1.1.0.jar`](https://github.com/bilbillm/DGLab-Craft/releases/tag/v1.1.0-1.18.2)
2. 在页面下方找到 **Assets**。
3. 下载 `DGLabCraft-1.18.2-1.1.0.jar`。
...
```bash
pwsh scripts/release-check.ps1 -Tag v1.1.0-1.18.2 -SkipGitHubReleaseCheck
pwsh scripts/release-postcheck.ps1 -Tag v1.1.0-1.18.2
```
